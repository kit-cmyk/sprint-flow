...
import { LayoutDashboard, TableProperties, UsersRound } from "lucide-react"
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
// PO can view overview and allocation, but not team settings
const tabs = [
  { value: "overview", label: "Overview", icon: LayoutDashboard },
  { value: "allocation", label: "Allocation Matrix", icon: TableProperties },
] as const

export default function POTeamDetailPage({
  params,
}: {
